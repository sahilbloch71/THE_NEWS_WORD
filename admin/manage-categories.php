...
<html lang="en">
    <head>
        ...
        <title>BJS TECH THE NEWS WORLD | Manage Categories</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,PostingDate,CategoryName,Description,UpdationDate from  tblcategory where Is_Active=1");
$cnt=1;
...
<table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,PostingDate,CategoryName,Description,UpdationDate from  tblcategory where Is_Active=0");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>
